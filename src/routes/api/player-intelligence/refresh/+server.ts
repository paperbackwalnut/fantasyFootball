...
export const GET: RequestHandler = async ({ url }) => {
	...
	return json({ sleeper: sleeperRefreshStatus(), rankings: consensusRankingStatus(), adp: mflAdpStatus(teamCount), health: providerHealth(), projectionImportDirectory: projectionImportDirectory() }, { headers: { 'cache-control': 'no-store' } });
};
