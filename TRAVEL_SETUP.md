...
5. Confirm the popup says **Build 0.4.8**.
...
> Read AGENTS.md, README.md, and TRAVEL_SETUP.md completely. Inspect the current git status and recent commits. Continue the ESPN extension 0.4.8 validation described in AGENTS.md. Do not use the retired ffDraftSync repository or reintroduce Supabase.
