...
The popup must show **Build 0.3.1 · pre-draft + command bridge**. If it shows an older version, remove that Chrome extension entry and load this directory from the main repository; do not load the retired standalone `ffDraftSync` checkout.
