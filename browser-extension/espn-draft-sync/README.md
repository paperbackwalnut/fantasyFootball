...
The popup must show **Build 0.4.8 · recommendation audit**. If it shows an older version, click Reload on the unpacked extension (or remove and load this directory again); do not load the retired standalone `ffDraftSync` checkout.
