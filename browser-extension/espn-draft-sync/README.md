...
The popup must show **Build 0.3.3 · recommendation audit**. If it shows an older version, remove that Chrome extension entry and load this directory from the main repository; do not load the retired standalone `ffDraftSync` checkout.
